...
$LANG['bg'] = array(
    ...
    'list records'  => 'покажи %s записите',
    'add record'  => 'нов запис',
    'list accounts'  => 'списък %s акаунти',
    'add account'  => 'добави акаунт',
    'open webmail'  => 'отвори уебмейл',
    'list fail2ban' => 'списък fail2ban',
    'open %s'  => 'отвори %s',
    'download'  => 'сваляне',
    'restore'  => 'възстанови',
    'configure restore settings'  => 'настройки възстановяване',
    'stop'  => 'стоп',
    'start'  => 'старт',
    'restart'  => 'рестарт',
    'update'  => 'обнови',
    ...
    'reread IP' => 'reread IP',
    'enable autoupdate' => 'разреши автообновяване',
    'disable autoupdate' => 'забравни автообновяване',
    'turn on notifications' => 'включи уведомления',
    'turn off notifications' => 'изключи уведомления',

    'Adding User'  => 'Добави потребител',
    'Editing User'  => 'Редактирай потребител',
    'Adding Domain'  => 'Добави домейн',
    'Editing Domain'  => 'Редактирай домейн',
    'Adding DNS Domain'  => 'Добави DNS домейн',
    'Editing DNS Domain'  => 'Редактирай DNS домейн',
    'Adding DNS Record'  => 'Добави DNS запис',
    'Editing DNS Record'  => 'Редактирай DNS запис',
